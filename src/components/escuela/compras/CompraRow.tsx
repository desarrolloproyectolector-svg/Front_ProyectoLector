...
export default function CompraRow({ compra }: Props) {
  return (
    <tr className="block md:table-row bg-white md:bg-transparent mb-4 md:mb-0 rounded-xl md:rounded-none shadow-sm md:shadow-none border border-[#e3dac9] md:border-b md:border-transparent hover:bg-[#faf8f5] transition-colors duration-200">
      <td className="block md:table-cell py-3 md:py-4 px-4 md:px-4 border-b border-[#e3dac9]/30 md:border-0 md:text-center relative">
      ...
      <td className="block md:table-cell py-3 md:py-4 px-4 md:px-4 border-b border-[#e3dac9]/30 md:border-0 md:text-center">
        <span className="md:hidden text-[10px] font-bold uppercase text-[#a1887f] mb-2 block">Tipo</span>
        <span className="px-3 py-1 bg-gradient-to-r from-[#d4af37]/10 to-[#d4af37]/5 text-[#2b1b17] text-xs font-bold rounded-full border border-[#d4af37]/20 capitalize inline-block whitespace-nowrap">
          {compra.tipo}
        </span>
      </td>
      <td className="block md:table-cell py-3 md:py-4 px-4 md:px-4 border-b border-[#e3dac9]/30 md:border-0 text-[#5d4037] font-lora md:text-center">
      ...
      <td className="block md:table-cell py-3 md:py-4 px-4 md:px-4 border-b border-[#e3dac9]/30 md:border-0 md:text-center">
        ...
        <span
          className={`px-3 py-1 rounded-full text-xs font-bold inline-block whitespace-nowrap ${compra.estado === 'activa'
