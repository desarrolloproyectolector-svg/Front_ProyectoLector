...
const Tienda: React.FC<TiendaProps> = ({ onSelectBook }) => {
    ...
    return (
        <div className="animate-fade-in space-y-8 md:space-y-12">
            ...
            <div className="relative w-full h-48 md:h-64 bg-gradient-to-br from-[#2b1b17] via-[#3e2723] to-[#2b1b17] rounded-2xl overflow-hidden shadow-2xl">
                {/* Patrón decorativo */}
                <div
                ...
                <div className="relative z-10 h-full flex flex-col justify-center px-6 md:px-12 lg:px-16">
                    <div className="max-w-2xl">
                        ...
                        <div className="flex gap-3 mt-6">
                            <button className="px-6 py-2.5 bg-[#d4af37] text-[#2b1b17] rounded-lg font-bold text-sm hover:bg-[#c19a2e] transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 flex items-center gap-2">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
                                </svg>
                                Ver Destacados
                            </button>
                            <button className="px-6 py-2.5 bg-white/10 backdrop-blur-sm text-white rounded-lg font-bold text-sm hover:bg-white/20 transition-all duration-300 border border-white/20">
                                Explorar Todo
                            </button>
                        </div>
                    </div>
                ...
                {showFilters && (
                    <div className="mt-6 pt-6 border-t border-[#e3dac9] animate-in slide-in-from-top-2 duration-300">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            <button className="px-4 py-2 bg-[#fbf8f1] hover:bg-[#d4af37] hover:text-white border border-[#e3dac9] hover:border-[#d4af37] rounded-lg text-sm font-bold text-[#5d4037] transition-all duration-300">
                                Todos
                            </button>
                            <button className="px-4 py-2 bg-white hover:bg-[#d4af37] hover:text-white border border-[#e3dac9] hover:border-[#d4af37] rounded-lg text-sm font-bold text-[#5d4037] transition-all duration-300">
                                Gratuitos
                            </button>
                            <button className="px-4 py-2 bg-white hover:bg-[#d4af37] hover:text-white border border-[#e3dac9] hover:border-[#d4af37] rounded-lg text-sm font-bold text-[#5d4037] transition-all duration-300">
                                En Mi Biblioteca
